...
export const metadata: Metadata = {
  title: "Free LinkedIn Intelligence Tools | OkGTM Labs",
  description:
    "Six free LinkedIn tools to spy on competitor ads, steal warm leads, and decode content strategies. No signup. Results in under a minute.",
};
      ...
      >
        <div className="mx-auto w-full max-w-[1280px] px-6">
          <div className="mx-auto max-w-[640px] text-center">
            ...
            >
              Six tools. No signup. Paste a URL and get answers in under a&nbsp;minute.
            </p>
            ...
            >
              Every tool is free to use, right now. No account, no email, no credit&nbsp;card.
            </p>
          </div>
        </div>
      </section>
